...
We’ve tidied up the interface by removing awkward empty spaces and fixing issues with some back arrows. Navigating through your sub-menus should now feel as smooth and predictable as you'd expect.
...
New **Distribution Card**: This brand-new graph card is perfect for visualizing how a total value is split across different entities. It’s a great way to see exactly where your energy is going or how your storage is being used.
